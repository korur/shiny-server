...
share <- list(
  ...
  url = "http://tools.dataatomic.com/shiny/CoronaOutbreak1_/",
...
body <- dashboardBody(  tags$head(golem::activate_js(),
  ...
  tags$link(rel = "shortcut icon", type="image/x-icon", href="http://tools.dataatomic.com/shiny/CoronaOutbreak1_/favicon.ico"),
