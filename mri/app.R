    ...
    fluidRow(
      column(3, selectInput(
        "demo_dt", "Choose a Demo Data", choices = c(
          ...
          "4D Brain fMRI" = "data/4d_fmri.nii.gz", "HH-1212" = "data/IXI013-HH-1212-T1.nii.gz",
         "HH-1236" = "data/IXI014-HH-1236-T1.nii.gz", "HH-1258" = "data/IXI015-HH-1258-T1.nii.gz", "Guys-0697" = "data/IXI016-Guys-0697-T1.nii.gz"
          )
      )),
